...
bool loadMedia()
{
	...
	else if (!gGameOver.loadFromRenderedText("GAME OVER", {140, 140, 140}) || !gPlayAgainTexture.loadFromRenderedText("Press s to play again!", {60, 100, 100}) || !gWin.loadFromRenderedText("Congrats!!", {140, 140, 140}))
	{
	...
	// Load các âm thanh
	clickMenu = Mix_LoadWAV(menuSoundPath.c_str());
	...
	if (clickMenu == nullptr || openCell == nullptr || mineFounded == nullptr || winning == nullptr || flag == nullptr || unFlag == nullptr)
	{
